...
@section('content')
	...
	<section class="sample-text-area">
		<div class="container"> 
		<div class="field-item even"><p><a href="http://majormouse.org/" target="_blank"><img alt="" src="/sites/longparse/files/mmtp_facebook.jpg" style="float: left; width: 700px; height: 265px;"></a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p><strong>So why is science to address this progressing so slowly?</strong></p>
...
<p><strong>What can we do to increase healthy lifespan?</strong></p>
...
<p>This is why we believe the <a href="http://majormouse.org" target="_blank">MMTP</a> is the ideal project to speed up progress in aging research and make a significant contribution towards interventions that can positively affect our health and longevity. This could be the key to unlocking the fantastic potential of regenerative medicine for the benefit of all mankind!</p>
<p>Support the project anytime by <a href="http://longevityalliance.org/?q=donate" target="_blank">donating to the ILA</a>, or invest in the scientific researh of longevity therapies during active crowdfunding campaigns!</p>
</div>
		</div>
	</section>
@endsection
